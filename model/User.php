...
class User extends DB {
  ...
  public function add($arr){
    $sql = "INSERT INTO user(user_name,password,email,name,gender,age,job,comment,role,created)VALUES(:user_name,:password,:email,:name,:gender,:age,:job,:comment,:role,:created)";
    $stmt = $this->connect->prepare($sql);
    $params = array(
